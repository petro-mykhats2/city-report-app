...
export function AuthTabs() {
  ...
  const handleSignup = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "Welcome to City Report App. You can now start contributing to your community.",
    })
  }
          ...
          <CardContent>
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="location" placeholder="Your city or neighborhood" />
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="newsletter" className="text-sm">
                    Send me updates about community reports and city improvements
                  </Label>
                </div>
              </div>
